...
(function($) {
	...
	var PanelModel = function (index, data_index, settings) 
	{
		...
		this.init = function () {
			...
			$(this.elem).css({ "font-size": "20px", "line-height": "65px" });
			$(this.elem).css(
	...
	var Drum = function(element, options, transformProp)
	{
		...
		var transform = function() {
			...
			if (selected) {
				...
				$(selected.elem).css({ "font-size": "65px", "line-height": "100px" });
				$("figure:not(.a" + (selected.angle * 100) + ", .hidden)", drum).css({ "font-size": "20px", "line-height": "90px" });

				$(selected.elem).prev("figure").css({ "font-size": "20px", "line-height": "90px" });
				$(selected.elem).next("figure").css({ "font-size": "20px", "line-height": "125px" });

				//$(selected.elem).prev(".a0").css({ "font-size": "20px", "line-height": "80px" });
